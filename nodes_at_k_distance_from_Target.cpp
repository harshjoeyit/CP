...
/*
node at distance k can be in one of three places
a. left subtree
b. right subtree
c. towards parent

It is easy to check is l left and right subtree

what about parent

It becomes simple for parent too, if we know the distance of target from parent

So find distance from target to parent, using backtracking.
*/
