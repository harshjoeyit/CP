...
class debian
{
    ...
    public:
        ...
        // defalut constructor
        debian(): debian("","", INT_MIN) { }       // delegates to 1 for initialization 
        debian( string d1 , string d2 ): debian( d1 ,d2 , 0) { }       // also delegates to 1
        debian( istream &input ): debian() { read( input); }    // delegates to default sonstructor , which delegates to constructor 1
