...
int main() {
    ...
    int i = -42;
    absInt absObj;
    // although abs is an object , we can use the function call operator
    int ui = absObj(i);          
    cout<<ui<<endl;
    ...
    // gives anew line after printing
    errors("revoke");                           
    ...
    replace_if(svec.begin(), svec.end() , CompareString("motel42") , "Replaced" );
