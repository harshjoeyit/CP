...
The nested class is also a member variable of the enclosing class 
and has the same access rights as the other members.

>>> However, the member functions of the enclosing class have no special
...
int main() {
    ...
    budget *b = new budget(1000, {140, 20, 40});
    cout<<"expense: "<< b->expense();
    cout<<" savings: "<< b->savings()<<endl;
}
